...
joint2 = rtb.RevoluteDH(d=l3, alpha=np.pi/2, a=0, offset=0, qlim=(-0.01, 0.01))
joint3 = rtb.RevoluteDH(d=l4, alpha=np.pi/2, a=0, offset=0, qlim=(-0.01, 0.01))
ee = rtb.RevoluteDH(d=l5, a=0, alpha=0, offset=0, qlim=(-0.01, 0.01))
qube_pendulum_robot = rtb.DHRobot([joint1, joint2, joint3, ee], name="Qube+pendulum")

q = np.array([0, theta, alpha, 0])
